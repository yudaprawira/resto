    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <form method="POST" action="{{ BeUrl(config('divisi.info.alias').'/save') }}" id="formData">
                ...
                <div class="form-group has-feedback">
                    <label>{{ trans('divisi::global.nama') }}</label><span class="char_count"></span>
                ...
                <a href="{{ BeUrl(config('divisi.info.alias').'/edit/0') }}" class="btn btn-default btn-flat btn-reset">{{ trans('global.act_back') }}</a>
                </form>
