            ...
            <div class="box">
                ...
                <div class="box-body">
                  ...
                  <form method="POST" action="{{ BeUrl(config('pengadaan.info.alias').'/save') }}">
                    ...
                    <div class="form-group has-feedback">
                        <label>{{ trans('pengadaan::global.judul') }}</label><span class="char_count"></span>
                    ...
                    <a href="{{ BeUrl(config('pengadaan.info.alias')) }}" class="btn btn-default btn-flat btn-reset">{{ trans('global.act_back') }}</a>
                  </form>
